...
ref_person = cv.imread('./Referential_images/image14.png')
ref_mobile = cv.imread('./Referential_images/image4.png')
ref_book = cv.imread('./Referential_images/image5.png')
ref_ball = cv.imread('./Referential_images/image2.png')
ref_bottle = cv.imread('./Referential_images/image0.png')
